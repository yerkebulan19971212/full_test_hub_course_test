...
from src.quizzes.api_views import (by_lesson_finish_view,
                                   ...
                                   repeat_flash_card_view, my_progress_view, my_lesson_progress_view)
from src.quizzes.api_views.full_test import new_test_view
...
api_v1_urlpatterns = [
    ...
    path('new-test/', new_test_view),
    path('my-test-progress/', my_progress_view),
    path('my-lesson-progress/', my_lesson_progress_view),
