...
from .flash_card import (get_flash_card_question, new_flash_card_view,
                         repeat_flash_card_view, result_flash_card_question,
                         pass_flash_card_question, finish_flash_card_view)
from .full_test import (full_quizz_lesson_view, full_quizz_question_view,
                        ...
                        result_rating, my_progress_view, my_lesson_progress_view)
