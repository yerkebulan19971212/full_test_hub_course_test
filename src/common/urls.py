...
from src.common.super_admin_views import (add_question_view,
                                          ...
                                          get_update_common_view, question_items_list_view, update_answers_question_view)
from src.common.views import support_view, test_view
...
api_v1_super_admin_urlpatterns = [
    ...
    path('answer-question/', update_answers_question_view),
